            ...
            <?php else: ?>
                ...
                <?php foreach ($buku_list as $buku): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($buku['kurikulum'] ?? '-'); ?></td>
                        ...
                        <td>
                            <button type="button" 
                                    ...
                                    data-kurikulum="<?php echo htmlspecialchars($buku['kurikulum'] ?? ''); ?>"
    ...
    <div id="createForm" class="modal">
        <div class="modal-content">
            ...
            <form action="../controller/bukuController.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group"><label>Tahun Terbit:</label><input type="number" name="tahun_terbit" min="1900" max="2099"></div>
    ...
    <div id="editForm" class="modal">
        <div class="modal-content">
            ...
            <form action="../controller/bukuController.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group"><label>Kode Buku:</label><input type="text" id="edit_kode_buku" name="kode_buku" required></div>
                <div class="form-group"><label>Judul Buku:</label><input type="text" id="edit_judul_buku" name="judul_buku" required></div>
                <div class="form-group"><label>Penulis:</label><input type="text" id="edit_penulis" name="penulis" required></div>
                <div class="form-group"><label>ISBN:</label><input type="text" id="edit_isbn" name="isbn"></div>
                <div class="form-group"><label>Penerbit:</label><input type="text" id="edit_penerbit" name="penerbit"></div>
                <div class="form-group"><label>Tahun Terbit:</label><input type="number" id="edit_tahun_terbit" name="tahun_terbit" min="1900" max="2099"></div>
                ...
                <div class="form-group">
                    <label>Kurikulum:</label>
                    <select name="kurikulum" id="edit_kurikulum">
